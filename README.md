...
| 문서 | 내용 |
|---|---|
| [`docs/system_architecture.md`](docs/system_architecture.md) | 전체 시스템 아키텍처와 모듈 역할 |
| [`docs/communication_protocol.md`](docs/communication_protocol.md) | 노트북–ESP32 TCP 통신 명세 |
| [`docs/control_state_machine.md`](docs/control_state_machine.md) | ESP32 차량 상태머신과 안전 전이 |
| [`docs/hardware_wiring.md`](docs/hardware_wiring.md) | 전원 및 제어 배선 |
| [`docs/test_log_summary.md`](docs/test_log_summary.md) | 테스트 결과 요약 |
| [`docs/development_log.md`](docs/development_log.md) | 날짜별 개발 기록 |
| [`docs/troubleshooting.md`](docs/troubleshooting.md) | 문제 원인과 해결 과정 |

추후 FreeRTOS Task 설계, SW 연동 인터페이스, 통합 테스트 계획 문서를 추가할 예정이다.
...
│  └─ troubleshooting.md
├─ firmware_esp32/
│  └─ ESP32 단위 테스트 및 최종 펌웨어
├─ integrated/
│  └─ 노트북 상위 제어기와 ESP32 통합 코드
└─ assets/
   ├─ diagrams/
   ├─ photos/
   └─ demo_links/
