...
SERVO_LEFT_STRONG = 50.0
SERVO_LEFT_WEAK = 68.0
SERVO_CENTER = 86.0
SERVO_RIGHT_WEAK = 104.0
SERVO_RIGHT_STRONG = 122.0
MOTOR_MAX_PWM = 255
PWM_FORWARD_MIN = 15
PWM_FORWARD_DEFAULT = 27
PWM_TURN_MIN = 35
PWM_TURN_DEFAULT = 45
PWM_STRONG_TURN_DEFAULT = 55
MOTOR_DEADBAND = 0.02
...
class MockEsp32:
    ...
    def throttle_to_pwm(cls, throttle, steering):
        ...
        if abs_steering <= 0.5:
            ...
            min_pwm = cls._lerp(PWM_TURN_MIN, PWM_STRONG_TURN_DEFAULT, t)
